...
public class BpSDKDemo extends AppCompatActivity { //implements BPHeadsetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logStatus("Send Analytics : " + BPSdk.getSendAnalytics());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_toggle_sendanalytics:
                boolean mSendAnalytics=!BPSdk.getSendAnalytics();
                BPSdk.setSendAnalytics(mSendAnalytics);
                logStatus("Send Analytics:"+BPSdk.getSendAnalytics());
                item.setTitle(mSendAnalytics?"Stop Analytics":"Send Analytics");
                return true;
